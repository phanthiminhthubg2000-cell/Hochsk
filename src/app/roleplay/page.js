...
const SCENARIOS = [
  ...
  // HSK 2
  { id: "h2_1", level: "HSK 2", icon: "🛍️", title: "Mua quần áo", xp: 40, userRole: "Khách", aiRole: "Nhân viên", aiName: "售货员", aiAvatar: "💁‍♀️", vocab: ["衣服", "颜色", "试"], missions: ["Hỏi tìm áo màu đỏ", "Yêu cầu thử đồ", "Hỏi xem có hợp không"], greeting: "ZH: 您好，想看点什么衣服？\nPY: Nín hǎo, xiǎng kàn diǎn shénme yīfú?\nVI: Chào bạn, bạn muốn xem quần áo gì?" },
  ...
  { id: "h3_2", level: "HSK 3", icon: "🏦", title: "Mở tài khoản NH", xp: 50, userRole: "Khách hàng", aiRole: "Nhân viên NH", aiName: "柜员", aiAvatar: "🏦", vocab: ["银行", "卡", "办"], missions: ["Nêu yêu cầu mở thẻ", "Cung cấp giấy tờ", "Hỏi về phí thường niên"], greeting: "ZH: 您好，请问要办理什么业务？\nPY: Nín hǎo, qǐngwèn yào bànlǐ shénme yèwù?\nVI: Chào bạn, bạn muốn làm nghiệp vụ gì?" },
  { id: "h3_3", level: "HSK 3", icon: "✈️", title: "Đặt vé máy bay", xp: 50, userRole: "Khách hàng", aiRole: "Tổng đài", aiName: "客服", aiAvatar: "🎧", vocab: ["航班", "起飞", "座位"], missions: ["Hỏi vé đi Thượng Hải ngày mai", "Chọn chỗ ngồi cạnh cửa sổ", "Xác nhận giờ cất cánh"], greeting: "ZH: 您好，这里是航空公司，请问需要什么帮助？\nPY: Nín hǎo, zhèlǐ shì hángkōng gōngsī, qǐngwèn xūyào shénme bāngzhù?\nVI: Chào bạn, đây là hãng hàng không, cần giúp gì ạ?" },
  ...
  { id: "h3_6", level: "HSK 3", icon: "🏠", title: "Thuê nhà", xp: 50, userRole: "Người thuê", aiRole: "Môi giới", aiName: "中介", aiAvatar: "📋", vocab: ["租房", "环境", "附近"], missions: ["Hỏi giá thuê phòng 1 tháng", "Hỏi xung quanh có siêu thị không", "Thương lượng giảm giá"], greeting: "ZH: 您好，想看什么样的房子？\nPY: Nín hǎo, xiǎng kàn shénme yàng de fángzi?\nVI: Chào bạn, muốn xem kiểu nhà thế nào?" },
  ...
  { id: "h3_9", level: "HSK 3", icon: "🏥", title: "Khám bệnh", xp: 50, userRole: "Bệnh nhân", aiRole: "Bác sĩ", aiName: "医生", aiAvatar: "🩺", vocab: ["检查", "一直", "注意"], missions: ["Miêu tả đau bụng từ hôm qua", "Hỏi xem có cần xét nghiệm không", "Hỏi chế độ ăn uống"], greeting: "ZH: 肚子疼？疼了多久了？\nPY: Dùzi téng? Téng le duōjiǔ le?\nVI: Đau bụng à? Đau bao lâu rồi?" },
  { id: "h3_10", level: "HSK 3", icon: "🗺️", title: "Kế hoạch du lịch", xp: 50, userRole: "Bạn du lịch", aiRole: "Bạn đồng hành", aiName: "李明", aiAvatar: "🎒", vocab: ["旅游", "决定", "风景"], missions: ["Gợi ý đi Vân Nam", "Giải thích vì sao chọn nơi đó", "Chốt thời gian mua vé"], greeting: "ZH: 下个月放假，我们去哪儿玩？\nPY: Xià gè yuè fàngjià, wǒmen qù nǎ'er wán?\nVI: Tháng sau nghỉ lễ, chúng ta đi đâu chơi?" },
  ...
  { id: "h4_2", level: "HSK 4", icon: "💰", title: "Thương lượng giá", xp: 60, userRole: "Người mua sỉ", aiRole: "Nhà cung cấp", aiName: "王总", aiAvatar: "🏭", vocab: ["价格", "降低", "合作", "质量"], missions: ["Yêu cầu giảm giá 10%", "Đề xuất hợp tác lâu dài", "Xác nhận thời gian giao hàng"], greeting: "ZH: 我们的价格已经是最低了，质量绝对有保证。\nPY: Wǒmen de jiàgé yǐjīng shì zuì dī le, zhìliàng juéduì yǒu bǎozhèng.\nVI: Giá của chúng tôi đã là thấp nhất rồi, chất lượng tuyệt đối đảm bảo." },
  ...
  { id: "h6_3", level: "HSK 6", icon: "🚨", title: "Khủng hoảng PR", xp: 100, userRole: "CEO", aiRole: "Giám đốc PR", aiName: "公关总监", aiAvatar: "📱", vocab: ["舆论", "澄清", "挽回", "危机"], missions: ["Phân tích nguyên nhân khủng hoảng bùng nổ", "Chỉ đạo soạn thảo thông cáo báo chí", "Quyết định phương án xin lỗi công chúng"], greeting: "ZH: 董事长，网上的负面舆论正在发酵，我们必须在两小时内给出官方回应。\nPY: Dǒngshìzhǎng, wǎng shàng de fùmiàn yúlùn zhèngzài fājiào...\nVI: Thưa Chủ tịch, dư luận tiêu cực trên mạng đang lên men, chúng ta phải có phản hồi chính thức trong 2 giờ." },
  { id: "h6_4", level: "HSK 6", icon: "⚖️", title: "Đạo đức AI", xp: 100, userRole: "Nhà lập pháp", aiRole: "Chuyên gia", aiName: "科技专家", aiAvatar: "💻", vocab: ["隐私", "伦理", "约束", "滥用"], missions: ["Cảnh báo nguy cơ xâm phạm quyền riêng tư", "Đề xuất luật kiểm soát dữ liệu", "Tranh luận về sự phát triển tự do"], greeting: "ZH: 过度监管会扼杀科技创新，AI的伦理边界到底应该由谁来界定？\nPY: Guòdù jiānguǎn huì èshā kējì chuàngxīn, AI de lúnlǐ biānjiè dàodǐ yīnggāi yóu shéi lái jièdìng?\nVI: Giám sát quá mức sẽ bóp nghẹt đổi mới công nghệ, ranh giới đạo đức của AI rốt cuộc nên do ai định đoạt?" },
  { id: "h6_5", level: "HSK 6", icon: "🎨", title: "Lịch sử nghệ thuật", xp: 100, userRole: "Người thưởng lãm", aiRole: "Giám tuyển", aiName: "馆长", aiAvatar: "🖼️", vocab: ["流派", "审美", "反映", "独特"], missions: ["Phân tích giá trị của nghệ thuật đương đại", "So sánh với trường phái cổ điển", "Bình luận về một tác phẩm cụ thể"], greeting: "ZH: 当代艺术往往打破常规，你如何理解这幅毫无逻辑的画作？\nPY: Dāngdài yìshù wǎngwǎng dǎpò chángguī, nǐ rúhé lǐjiě zhè fú kànsì háowú luójí de huàzuò?\nVI: Nghệ thuật đương đại thường phá vỡ quy củ, bạn hiểu thế nào về bức tranh nhìn như vô lý này?" },
  { id: "h6_6", level: "HSK 6", icon: "🧩", title: "Hiện tượng tâm lý", xp: 100, userRole: "Sinh viên", aiRole: "Giáo sư Tâm lý", aiName: "导师", aiAvatar: "📖", vocab: ["潜意识", "压抑", "因素", "症状"], missions: ["Trình bày về chứng rối loạn lo âu", "Phân tích tác động của mạng xã hội", "Đề xuất hướng can thiệp"], greeting: "ZH: 在信息爆炸的时代，“信息焦虑症”越来越普遍，你认为其根本心理动因是什么？\nPY: Zài xìnxī bàozhà de shídài, “xìnxī jiāolǜ zhèng” yuè lái yuè pǔbiàn...\nVI: Trong thời đại bùng nổ thông tin, 'chứng lo âu thông tin' ngày càng phổ biến, bạn nghĩ động cơ tâm lý căn bản là gì?" },
  { id: "h6_7", level: "HSK 6", icon: "🎓", title: "Bảo vệ luận án", xp: 100, userRole: "Nghiên cứu sinh", aiRole: "Giám khảo", aiName: "主考官", aiAvatar: "👨‍⚖️", vocab: ["论证", "缺陷", "贡献", "严谨"], missions: ["Bảo vệ phương pháp nghiên cứu", "Thừa nhận hạn chế của đề tài", "Khẳng định đóng góp thực tiễn"], greeting: "ZH: 你的论文逻辑清晰，但在样本采集上是否缺乏一定的普遍性？请你辩护。\nPY: Nǐ de lùnwén luójí qīngxī, dàn zài yàngběn cǎijí shàng shìfǒu quēfá yīdìng de pǔbiàn xìng? Qǐng nǐ biànhù.\nVI: Luận văn của bạn logic rõ ràng, nhưng trong việc thu thập mẫu có phải thiếu tính phổ quát không? Mời biện hộ." },
  { id: "h6_8", level: "HSK 6", icon: "🌐", title: "Quan hệ quốc tế", xp: 100, userRole: "Nhà ngoại giao", aiRole: "Phóng viên", aiName: "资深记者", aiAvatar: "🎤", vocab: ["摩擦", "合作", "局势", "互利"], missions: ["Bình luận về căng thẳng thương mại", "Nhấn mạnh lập trường hòa bình", "Nêu bật tầm quan trọng của hợp tác"], greeting: "ZH: 面对当前复杂的国际地缘政治局势，贵国的外交战略重心会发生转移吗？\nPY: Miànduì dāngqián fúzá de guójì dìyuán zhèngzhì júshì...\nVI: Đối mặt với cục diện địa chính trị quốc tế phức tạp hiện nay, trọng tâm chiến lược ngoại giao của quý quốc có dịch chuyển không?" },
...
export default function RoleplayPage() {
  ...
  const startFreeChat = () => {
    ...
    setChatHistory([{ 
      ...
      showTranslation: false, showCoach: false
    }]);
  };
  ...
  const startRoleplay = (scenario) => {
    ...
    setChatHistory([{ role: 'assistant', content: scenario.greeting, showTranslation: false, showCoach: false }]);
  };

  // --- LOGIC GỬI TIN NHẮN & CHẤM ĐIỂM NHIỆM VỤ THÔNG MINH ---
    ...
    try {
      ...
      if (hasFeedback) {
        coachFeedback = phase === "free_chat" 
          ...
          : "Phản xạ rất tốt! Cố gắng bám sát từ vựng gợi ý của tình huống để ghi điểm.";
      }

      setChatHistory([...newHistory, { role: 'assistant', content: data.reply || data.answer || "AI không phản hồi.", showTranslation: false, showCoach: false, coachFeedback: coachFeedback }]);

      // CƠ CHẾ CHẤM NHIỆM VỤ DỰA TRÊN TỪ KHÓA
      if (phase === "roleplaying" && activeScenario) {
        const userContentLower = content.toLowerCase();
        let newCompleted = [...completedMissions];
        
        activeScenario.vocab.forEach((v, index) => {
          if (userContentLower.includes(v.toLowerCase()) && !newCompleted.includes(index)) {
            if (index < activeScenario.missions.length) {
              newCompleted.push(index);
            }
          }
        });

        if (content.length > 8 && newCompleted.length < activeScenario.missions.length && Math.random() > 0.7) {
          const uncompleted = activeScenario.missions.map((_, i) => i).filter(i => !newCompleted.includes(i));
          if (uncompleted.length > 0) newCompleted.push(uncompleted[0]);
        }

        setCompletedMissions([...new Set(newCompleted)]);
      }
    ...
    return (
      <div className="flex flex-col w-full animate-fade-in">
        <div className="flex items-start gap-3 mb-2">
          <div className="w-10 h-10 rounded-full bg-white/90 backdrop-blur-md border border-white/40 flex items-center justify-center text-xl shadow-sm shrink-0">
            {avatar}
          </div>
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{name}</p>
            <div className="mt-1 bg-white/90 backdrop-blur-md p-4 rounded-2xl rounded-tl-sm shadow-sm border border-white/50">
              <div className="flex items-center gap-3">
                <p className="text-[15px] font-medium text-slate-800 leading-relaxed whitespace-pre-wrap">{zh}</p>
              </div>
            </div>
            
            <div className="flex items-center gap-2 mt-2 ml-1">
              <button onClick={() => speak(zh)} className="text-[11px] font-bold text-slate-500 hover:text-[#08A66A] flex items-center gap-1 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-lg border border-white/50 shadow-sm transition">
                <span className="text-sm">🔊</span> Nghe
              </button>
              <button onClick={() => toggleTranslate(index)} className={`text-[11px] font-bold flex items-center gap-1 px-2 py-1 rounded-lg border shadow-sm transition ${msg.showTranslation ? 'bg-[#F0FDF4] text-[#10A66A] border-[#10A66A]/30' : 'bg-white/80 backdrop-blur-sm text-slate-500 hover:text-[#08A66A] border-white/50'}`}>
                <span className="text-sm">👁</span> Dịch
              </button>
              {msg.coachFeedback && (
                <button onClick={() => toggleCoach(index)} className={`text-[11px] font-bold flex items-center gap-1 px-2 py-1 rounded-lg border shadow-sm transition ${msg.showCoach ? 'bg-[#FFF8E8] text-amber-600 border-[#FFC83D]/30' : 'bg-white/80 backdrop-blur-sm text-amber-500 hover:bg-amber-50 border-white/50'}`}>
            ...
            {msg.showTranslation && (
              <div className="mt-2 bg-white/60 backdrop-blur-md p-3 rounded-xl border border-white/40 animate-slide-down max-w-sm">
                {py && <p className="mb-1 text-[#10A66A] font-semibold text-sm">{py}</p>}
                {vi && <p className="text-slate-600 text-sm">{vi}</p>}
              </div>
            )}

            {msg.showCoach && msg.coachFeedback && (
              <div className="mt-2 bg-[#FFF8E8]/90 backdrop-blur-md p-4 rounded-xl border border-[#FFC83D]/40 animate-slide-down relative overflow-hidden max-w-sm">
      ...
      <div className={`flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative z-10 transition-all duration-300 ${isSidebarCollapsed ? "md:pl-[76px]" : "md:pl-[240px]"}`}>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar relative">
              ...
              <div className="flex-1 bg-white/80 backdrop-blur-2xl border border-white/50 rounded-[32px] shadow-xl shadow-emerald-900/5 flex flex-col overflow-hidden">
                ...
                <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 custom-scrollbar scroll-smooth">
                  {chatHistory.map((msg, i) => {
                    ...
                    } else return <div key={i}>{renderAiMessage(msg, i)}</div>;
                  })}
                  {isChatting && (
          ...
          {phase === "roleplaying" && activeScenario && (
            <div className="max-w-[1400px] mx-auto h-[calc(100vh-80px)] flex flex-col lg:flex-row gap-6 p-4 md:p-6 animate-fade-in">
